	   ...
	   char ** args)
{
   ...
   */
   ...
   mySem = sem_create("my semaphore", 1);
   if(mySem == NULL) panic ("maths: sem create failed");
  /*
  ...
  //Biggest problem of this assignment was what is this P() doing here.
  //Apparently, it's being used as thread_join(), when realizing that, i created a new semaphore.
